...
set PATH=%PATH%;${OJDKBUILD_DIR}/tools/gradle48/bin
...
rem cmd /c gradle test --refresh-dependencies || exit /b 1
rem cmd /c gradle test -x :media:test -x :web:test --refresh-dependencies || exit /b 1
